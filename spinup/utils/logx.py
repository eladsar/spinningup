...
class Logger:
    ...
    def __init__(self, output_dir=None, output_fname='progress.txt', exp_name=None):
        ...
        """
        if proc_id() == 0:
            self.output_dir = output_dir or f"/tmp/experiments_{getpass.getuser()}/{int(time.time())}"
    ...
    def save_state(self, state_dict, itr=None):
        ...
        """
        if proc_id() == 0:
            fname = 'vars.pkl' if itr is None else f'vars_{itr:06d}.pkl'
            try:
                fpath = osp.join(self.output_dir, 'state')
    ...
    def _pytorch_simple_save(self, itr=None):
        ...
        if proc_id() == 0:
            ...
            fpath = 'pyt_save'
            fpath = osp.join(self.output_dir, fpath)
            fname = 'model' + (f'_{itr:06d}' if itr is not None else '') + '.pt'
